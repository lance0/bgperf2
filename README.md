...
log glob. Every row creates fresh tester instances; container reuse is
unsupported because it cannot prove this provenance.
...
expected diagnostics, as are reflected invalid-route withdrawals, and do not
increment the error count; other matching diagnostics remain visible in the
output statistics.
