...
class ConvergenceTracker(object):
    ...
    def __init__(self, no_progress_deadline_seconds=NO_PROGRESS_DEADLINE_SECONDS,
                 preserve_assurance_after_neighbors_checkpoint=False):
        ...
        self.fail_msg = None
        self.no_progress_deadline_seconds = no_progress_deadline_seconds
        self.preserve_assurance_after_neighbors_checkpoint = (
            preserve_assurance_after_neighbors_checkpoint
        )
    ...
    def update(self, elapsed_seconds, recved, neighbors_checked,
        ...
        if neighbors_checked != self.last_neighbors_checked:
            ...
            if not (self.neighbors_checkpoint
                    and self.preserve_assurance_after_neighbors_checkpoint):
                self.last_recved_count = 0
        ...
        if (elapsed_seconds > self.no_progress_deadline_seconds
